class ProductCard extends HTMLElement {
    ...
    render(){
      ...
      this.innerHTML = `
        <div class="relative flex flex-col justify-center items-center p-4" style="background-color: #F1EBEB">
        ...
        <div class="quickview-btn eye-icon flex justify-center items-center" onclick="clickModal(${this.product.id})" data-title="عرض سريع" data-product-id="${this.product.id}">
    ...
    ${!this.hideAddBtn ?
        ...
        <div class="s-product-card-content-main ${this.isSpecial ? 's-product-card-content-extra-padding' : ''}">
          ...
          <div class="s-product-card-content-sub ${this.isSpecial ? 's-product-card-content-extra-padding' : ''} flex justify-center items-center" style="justify-content : center !important ; margin:0px !important">
